...
- (IBAction)tappedSignUp:(id)sender {
    if ([self.emailField.text isEqual:@""]) {
        UIAlertController *emailAlert = [UIAlertController alertControllerWithTitle:@"Email Required" message:@"In order to create an account you must provide an email address." preferredStyle:(UIAlertControllerStyleAlert)];
        ...
        UIAlertController *passwordAlert = [UIAlertController alertControllerWithTitle:@"Password Required" message:@"In order to create an account you must provide a password." preferredStyle:(UIAlertControllerStyleAlert)];
...
- (IBAction)tappedLogin:(id)sender {
    if ([self.usernameField.text isEqual:@""]) {
        ...
        UIAlertController *passwordAlert = [UIAlertController alertControllerWithTitle:@"Password Required" message:@"In order to login you must provide a password." preferredStyle:(UIAlertControllerStyleAlert)];
